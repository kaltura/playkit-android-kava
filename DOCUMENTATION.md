...
dependencies {
    ...
    implementation 'com.kaltura.playkit:playkit:x.x.x' //instead of XXX use latest version i.e. implementation 'com.kaltura.playkit:playkit:3.4.1' 
...
## How to integrate KAVAPlugin into your application
